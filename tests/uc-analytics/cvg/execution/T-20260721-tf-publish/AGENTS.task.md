# Task brief — T-20260721-tf-publish
...
```bash
python3 skills/task-to-runtime-contract/scripts/check-path-policy.py --profile cvg/execution/T-20260721-tf-publish/execution-profile.yaml --base "$CVG_BASE_REF"
```
